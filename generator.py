...
def main(map_name, height, width, has_intersections, map_density, has_border, side_objects, road_objects, hard_mode):
    f.write("tiles:\r\n")
...
if __name__ == "__main__":
    ...
    main(args.map_name, args.height, args.width, has_intersections, map_density, has_border, side_objects, road_objects, args.hard_mode)